...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased relative">
        ...
        @if (Session::has('message'))
            ...
            <div class="container absolute right-0 md:static mx-auto">
                <!-- Section: Design Block -->
                <section e-data="{open: true}" x-show="open">
                    <div
                        class="alert alert-dismissible fade show items-center justify-between rounded-lg bg-purple-400 py-4 px-6 text-center text-white md:flex md:text-left">
